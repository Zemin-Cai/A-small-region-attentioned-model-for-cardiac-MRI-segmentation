...
from dataset.dataset_acdc import ACDC_dataset
from utils import test_single_volume
from network.network import ConvNextUNet

parser = argparse.ArgumentParser()
parser.add_argument('--volume_path', type=str,
                    default='root2/data/ACDC', help='root dir for validation volume data')
...
parser.add_argument('--output_dir', type=str, help='output dir', default='snapshot_path1/')
parser.add_argument('--max_iterations', type=int,default=30000, help='maximum epoch number to train')
parser.add_argument('--batch_size', type=int, default=24,  # 24
